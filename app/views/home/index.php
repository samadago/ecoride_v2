...
<section class="hero">
    <div class="carousel">
        <div class="carousel-inner">
            <div class="carousel-slide active" style="background-image: url('/assets/images/route.jpg')"></div>
            <div class="carousel-slide" style="background-image: url('/assets/images/voiture_eco.jpg')"></div>
            <div class="carousel-slide" style="background-image: url('/assets/images/voiture_electri.jpg')"></div>
        </div>
    ...
    <div class="container">
        <h2 class="hero-title">Voyagez écologique avec nous !</h2>
...
<section class="why-ecoride">
    <div class="container">
        <h2 class="section-title">Les avantages du covoiturage ecologique</h2>
        <div class="benefits">
...
<section class="about">
    <div class="container">
        ...
        <div class="about-content">
            ...
            <p class="contact-invite">- <a href="/contact">Une question ? Contactez-nous</a> -</p>
        </div>
    </div>
</section>
